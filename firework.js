...
//無論學業📚還是生活🌟㊗️
setTimeout(() => {
    displayText = "感謝父母的辛勞與支持"; // 20 秒後顯示
}, 30000);
...
setTimeout(() => {
    displayText = "謝謝你們的無私付出🥳❤️"; // 30 秒後顯示
}, 65000);
...
setTimeout(() => {
    displayText = "Happy New Year！ 🎊🎊🥳"; // 50 秒後顯示
}, 95000);
